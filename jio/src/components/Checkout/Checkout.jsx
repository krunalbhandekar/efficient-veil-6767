  ...
  return (
    <Flex>
      <Box p="20px"  w="50%">
            ...
            <Flex my="20px" gap="40px">
                <Box>
                     <Text>Expiry (M/Y) </Text>
                <input type="month" id="bdaymonth" name="bdaymonth" style={{border:"none", outline:"none"}}/>
                </Box>
                <Box>
            ...
            <Box my="10px">
                <Button backgroundColor="#008ecc" color="white"  onClick={() => {
